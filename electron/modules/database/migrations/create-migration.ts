 ...
 * Usage:
 *   # Direct execution
 *   node electron/modules/database/migrations/create-migration.ts add_user_preferences
 *
 *   # Or add to package.json scripts:
 *   "scripts": {
 *     "migration:create": "tsx electron/modules/database/migrations/create-migration.ts"
 *   }
 *
 *   # Then use:
