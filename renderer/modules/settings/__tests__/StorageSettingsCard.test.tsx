...
import StorageSettingsCard from "../Settings.components/StorageSettingsCard";
...
vi.mock("../Settings.components/storage/DeleteLeagueModal", () => ({
  default: (props: any) => (
...
vi.mock("../Settings.components/storage/DiskUsageSection", () => ({
  default: (_props: any) => <div data-testid="disk-usage" />,
}));

vi.mock("../Settings.components/storage/LeagueDataSection", () => ({
  default: (props: any) => (
