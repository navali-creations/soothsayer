...
interface StatsBiggestLetdownProps {
  data: BiggestLetdownHighlight | null;
}
...
export const StatsBiggestLetdown = ({ data }: StatsBiggestLetdownProps) => {
  ...
  return (
    ...
    >
      <div
        ...
        data-tip="The session where you opened the most decks but made the least profit"
      >
      ...
      <Stat.Title>Biggest Letdown</Stat.Title>
