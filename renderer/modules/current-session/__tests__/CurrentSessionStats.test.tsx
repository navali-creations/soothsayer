...
import CurrentSessionStats from "../CurrentSession.components/CurrentSessionStats/CurrentSessionStats";
...
vi.mock("../CurrentSession.components/CurrentSessionStats", () => ({
