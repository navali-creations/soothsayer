...
vi.mock(
  "../CardDetails.components/CardDetailsPriceSummary/PriceChangesRow",
  () => ({
    default: () => <div data-testid="price-changes-row" />,
  }),
);

vi.mock("../CardDetails.components/CardDetailsPriceSummary/PriceGrid", () => ({
  default: () => <div data-testid="price-grid" />,
}));

vi.mock(
  "../CardDetails.components/CardDetailsPriceSummary/PriceSummaryEmpty",
  () => ({
...
vi.mock(
  "../CardDetails.components/CardDetailsPriceSummary/PriceSummaryError",
  () => ({
...
vi.mock(
  "../CardDetails.components/CardDetailsPriceSummary/PriceSummaryHeader",
  () => ({
...
vi.mock(
  "../CardDetails.components/CardDetailsPriceSummary/PriceSummaryLoading",
  () => ({
...
import CardDetailsPriceSummary from "../CardDetails.components/CardDetailsPriceSummary/CardDetailsPriceSummary";
