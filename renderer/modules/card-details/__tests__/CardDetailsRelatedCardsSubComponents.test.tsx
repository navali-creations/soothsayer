...
vi.mock(
  "../CardDetails.components/CardDetailsRelatedCards/RelatedCardChip",
  () => ({
    default: ({ card }: any) => (
...
vi.mock("../CardDetails.components/CardDetailsRelatedCards/helpers", () => ({
...
import type RelatedCardChip from "../CardDetails.components/CardDetailsRelatedCards/RelatedCardChip";
import RelatedCardsSection from "../CardDetails.components/CardDetailsRelatedCards/RelatedCardsSection";
