...
vi.mock(
  "../CardDetails.components/CardDetailsPriceChart/PriceChartEmpty",
  () => ({
...
vi.mock(
  "../CardDetails.components/CardDetailsPriceChart/PriceChartError",
  () => ({
...
vi.mock("../CardDetails.components/CardDetailsPriceChart/helpers", () => ({
...
import CardDetailsPriceChart from "../CardDetails.components/CardDetailsPriceChart/CardDetailsPriceChart";
import ChartTooltip from "../CardDetails.components/CardDetailsPriceChart/ChartTooltip";
import {
  BRUSH_HEIGHT,
  CHART_HEIGHT,
} from "../CardDetails.components/CardDetailsPriceChart/constants";
