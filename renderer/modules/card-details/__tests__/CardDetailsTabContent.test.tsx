...
vi.mock("../CardDetails.components/CardDetailsPriceSummary", () => ({
  default: () => <div data-testid="price-summary" />,
}));

vi.mock("../CardDetails.components/CardDetailsPriceChart", () => ({
  default: () => <div data-testid="price-chart" />,
}));

vi.mock("../CardDetails.components/CardDetailsDropStats", () => ({
  default: () => <div data-testid="drop-stats" />,
}));

// ─── Child component stubs for YourDataTabContent ──────────────────────────

vi.mock("../CardDetails.components/CardDetailsPersonal", () => ({
  default: () => <div data-testid="personal" />,
}));

vi.mock("../CardDetails.components/CardDetailsDropTimeline", () => ({
  default: () => <div data-testid="drop-timeline" />,
}));

vi.mock("../CardDetails.components/CardDetailsSessionList", () => ({
...
vi.mock("../CardDetails.components/LoadingOverlay", () => ({
