...
vi.mock(
  "../CardDetails.components/CardDetailsSessionList/SessionListEmpty",
  () => ({
...
vi.mock(
  "../CardDetails.components/CardDetailsSessionList/SessionListError",
  () => ({
...
vi.mock(
  "../CardDetails.components/CardDetailsSessionList/SessionListPagination",
  () => ({
    default: (props: any) => (
      <div
...
vi.mock(
  "../CardDetails.components/CardDetailsSessionList/SessionListTable",
  () => ({
    default: (props: any) => (
      <div
        data-testid="table"
...
import CardDetailsSessionList from "../CardDetails.components/CardDetailsSessionList";
