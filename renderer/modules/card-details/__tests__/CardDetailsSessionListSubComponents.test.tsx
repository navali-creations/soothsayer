...
vi.mock("../CardDetails.components/CardDetailsSessionList/helpers", () => ({
  formatDate: (date: string) => `formatted-${date}`,
  formatDuration: (min: number) => `${min}m`,
}));

vi.mock(
  "../CardDetails.components/CardDetailsSessionList/SortIndicator",
  () => ({
...
import SessionListEmpty from "../CardDetails.components/CardDetailsSessionList/SessionListEmpty";
import SessionListError from "../CardDetails.components/CardDetailsSessionList/SessionListError";
import SessionListPagination from "../CardDetails.components/CardDetailsSessionList/SessionListPagination";
import SessionListTable from "../CardDetails.components/CardDetailsSessionList/SessionListTable";
