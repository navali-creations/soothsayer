...
vi.mock(
  "../CardDetails.components/CardDetailsDropTimeline/useDropTimelineData",
  () => ({
    useDropTimelineData: (...args: any[]) => mockUseDropTimelineData(...args),
  }),
);

vi.mock("../CardDetails.components/CardDetailsDropTimeline/MainChart", () => ({
  default: () => <div data-testid="main-chart" />,
}));

vi.mock(
  "../CardDetails.components/CardDetailsDropTimeline/OverviewChart",
  () => ({
...
import CardDetailsDropTimeline from "../CardDetails.components/CardDetailsDropTimeline";
