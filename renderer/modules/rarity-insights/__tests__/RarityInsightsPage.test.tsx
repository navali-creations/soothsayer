...
vi.mock("../RarityInsights.components/ComparisonTable", () => ({
  default: (_props: any) => <div data-testid="comparison-table" />,
}));

vi.mock("../RarityInsights.components/ComparisonToolbar", () => ({
  default: () => <div data-testid="comparison-toolbar" />,
}));

vi.mock("../RarityInsights.components/RarityInsightsHeaderActions", () => ({
  default: (props: any) => (
    <div
