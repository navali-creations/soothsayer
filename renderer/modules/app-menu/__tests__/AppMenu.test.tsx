...
import AppMenu from "../AppMenu.component/AppMenu";
...
vi.mock("../AppMenu.component/AppControls", () => ({
  default: () => <div data-testid="app-controls" />,
}));

vi.mock("../AppMenu.component/AppTitle", () => ({
  default: () => <div data-testid="app-title" />,
}));

vi.mock("../AppMenu.component/GameSelector/GameSelector", () => ({
