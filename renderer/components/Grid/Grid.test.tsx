...
describe("Grid", () => {
  it("renders as a ul element with default grid gap-4 classes", () => {
    renderWithProviders(<Grid data-testid="grid" />);
  ...
  it("merges a custom className with the defaults", () => {
    renderWithProviders(<Grid className="grid-cols-3 my-custom" />);
    const el = screen.getByRole("list");
...
describe("GridCol", () => {
  it("renders as a li element", () => {
    renderWithProviders(<GridCol>item</GridCol>);
  ...
  it("renders children and merges a custom className", () => {
    renderWithProviders(
      <GridCol className="col-span-2 extra">Content</GridCol>,
    );
