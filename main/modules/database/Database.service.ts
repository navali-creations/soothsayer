...
class DatabaseService {
  ...
  private initializeSchema(): void {
    ...
    `);
      ...
      // ═══════════════════════════════════════════════════════════════
      // FILTER TIER STYLES (per-filter rarity colour theme)
      // ═══════════════════════════════════════════════════════════════
      this.db.exec(`
      ...
      this.db.exec(`
        CREATE TABLE IF NOT EXISTS user_settings (
          ...
          app_performance_monitor_enabled INTEGER NOT NULL DEFAULT 0,
          app_performance_auto_start_on_session INTEGER NOT NULL DEFAULT 0,
          app_performance_retention TEXT NOT NULL DEFAULT '7d'
      ...
      // ═══════════════════════════════════════════════════════════════
      // APP PERFORMANCE DIAGNOSTICS (local-only capture data)
      // ═══════════════════════════════════════════════════════════════
      this.db.exec(`
