...
describe("RarityInsightsMapper", () => {
  // ═══════════════════════════════════════════════════════════════════════════
  // toRarityInsightsMetadataDTO
  // ═══════════════════════════════════════════════════════════════════════════

  describe("toRarityInsightsMetadataDTO", () => {
    it("should convert a database row to a RarityInsightsMetadataDTO", () => {
      const row = makeFilterMetadataRow();

      const result = RarityInsightsMapper.toRarityInsightsMetadataDTO(row);
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // toDiscoveredRarityInsightsDTO
  // ═══════════════════════════════════════════════════════════════════════════

  describe("toDiscoveredRarityInsightsDTO", () => {
    it("should convert RarityInsightsMetadataDTO to DiscoveredRarityInsightsDTO", () => {
      const metadata = RarityInsightsMapper.toRarityInsightsMetadataDTO(
        makeFilterMetadataRow(),
      );

      const result = RarityInsightsMapper.toDiscoveredRarityInsightsDTO(
        metadata,
        null,
      );
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // toRarityInsightsCardRarityDTO
  // ═══════════════════════════════════════════════════════════════════════════

  describe("toRarityInsightsCardRarityDTO", () => {
    it("should convert a database row to a RarityInsightsCardRarityDTO", () => {
  ...
  describe("isFilterOutdated", () => {
    ...
    it("should return false when filterLastUpdate is null", () => {
      const result = RarityInsightsMapper.isFilterOutdated(
        null,
        "2025-06-01T00:00:00Z",
      );
    ...
    it("should return false when both are null", () => {
      const result = RarityInsightsMapper.isFilterOutdated(null, null);
    ...
    it("should expose a 3-day grace period constant", () => {
      ...
      expect(RarityInsightsMapper.OUTDATED_GRACE_PERIOD_MS).toBe(threeDaysMs);
    });
  });
});
