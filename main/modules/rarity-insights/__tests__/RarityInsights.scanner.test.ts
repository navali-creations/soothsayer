...
describe("RarityInsightsScanner", () => {
  let scanner: RarityInsightsScanner;

  beforeEach(() => {
    vi.clearAllMocks();
    mockGetPath.mockReturnValue("C:\\Users\\TestUser\\Documents");
    scanner = new RarityInsightsScanner();
  });
  ...
  describe("parseOnlineHeader", () => {
    it("should extract #name and #lastUpdate from header lines", () => {
      ...
      const result = RarityInsightsScanner.parseOnlineHeader(lines);
    ...
    it("should return nulls for empty lines array", () => {
      const result = RarityInsightsScanner.parseOnlineHeader([]);
  ...
  describe("generateFilterId", () => {
    it("should generate a deterministic ID for a given path", () => {
      const id1 = RarityInsightsScanner.generateFilterId(
        "C:\\path\\to\\filter.filter",
      );
      const id2 = RarityInsightsScanner.generateFilterId(
        "C:\\path\\to\\filter.filter",
      );
    ...
    it("should prefix IDs with 'filter_'", () => {
      const id = RarityInsightsScanner.generateFilterId(
        "C:\\path\\test.filter",
      );
    ...
    it("should normalize path separators (backslash and forward slash)", () => {
      ...
      const id2 = RarityInsightsScanner.generateFilterId("C:/path/to/filter");
    ...
    it("should handle long paths", () => {
      ...
      const id = RarityInsightsScanner.generateFilterId(longPath);
