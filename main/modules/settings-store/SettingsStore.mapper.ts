 ...
 */
export function toAppSettingsDTO(row: UserSettingsRow): AppSettingsDTO {
  return {
 ...
 */
export function toPoe1SettingsDTO(row: UserSettingsRow): Poe1SettingsDTO {
  return {
 ...
 */
export function toPoe2SettingsDTO(row: UserSettingsRow): Poe2SettingsDTO {
  return {
